...
## We use the <<- operator to assign a value to an object in an environment 
## that is different from the current environment

## The first function, makeCacheMatrix creates a special "matrix", 
## which in reality is a list containing a function that does the following:
...
# created with the function makeCacheMatrix. It first checks to see if the inverse 
